...
refPosts.orderByKey().on('value', snapshot => {
    ...
    for (let i = 0; i < keys.length; i++) {
        ...
        pegandoElements += '<div class="hoverzoom mx-auto my-3 my-md-auto"><img src="'+image+'" alt="Imagem para Hoverzoom" /><div class="retina"><p>'+sinopse+'</p><a href="./index.html">Saiba mais</a></div></div>';
    }
